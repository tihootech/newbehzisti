...
<html lang="fa">
    <head>
        ...
        <!-- Main CSS-->
        <link rel="stylesheet" type="text/css" href="{{asset('dashboard/css/main.css')}}?v=2.3" />
        <link rel="stylesheet" type="text/css" href="{{asset('css/pdp.css')}}?v=2.3" />
        <!-- Font-icon css-->
    ...
    <body class="app sidebar-mini">
        ...
        <script src="{{asset('dashboard/js/main.js')}}?v=2.3"></script>
    </body>
</html>
